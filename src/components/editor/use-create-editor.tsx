...
import { copilotPlugins } from "@/src/components/editor/plugins/copilot-plugins";
import { editorPlugins } from "@/src/components/editor/plugins/editor-plugins";
...
import { AILeaf } from "@/src/components/plate-ui/ai-leaf";
...
import { EmojiInputElement } from "@/src/components/plate-ui/emoji-input-element";
...
import { SlashInputElement } from "@/src/components/plate-ui/slash-input-element";
import {
  TableCellElement,
...
import { TocElement } from "@/src/components/plate-ui/toc-element";
...
export const useCreateEditor = () => {
  return usePlateEditor({
    ...
    value: [
      {
        children: [{ text: "Éditeur de contenu" }],
        type: "h1",
      },
      {
        children: [
          {
            text: "Bienvenue dans votre éditeur de texte enrichi avec des fonctionnalités d'intelligence artificielle. Utilisez les ",
          },
          { bold: true, text: "commandes IA" },
          { text: " pour optimiser vos contenus ou appuyez sur " },
          { kbd: true, text: "Cmd+J" },
          { text: " pour accéder rapidement au menu IA." },
        ],
