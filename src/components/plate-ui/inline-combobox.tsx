...
const InlineComboboxContent: typeof ComboboxPopover = ({
  ...
  return (
    <Portal>
      <ComboboxPopover
        className={cn(
          "z-[500] max-h-[288px] w-[300px] overflow-y-auto rounded-md bg-popover shadow-xl",
          className
        )}
        {...props}
      />
...
const comboboxItemVariants = cva(
  "relative mx-1 flex select-none items-center rounded-sm px-2 py-2 text-sm text-foreground outline-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    defaultVariants: {
      interactive: true,
    },
