...
import { settingsStore } from "@/src/components/context/settings-store";
import { Icons, iconVariants } from "@/src/components/icons";
import { isEnabled } from "@/src/lib/plate-ui/is-enabled";
import { AlignDropdownMenu } from "@/src/registry/default/plate-ui/align-dropdown-menu";
import { ColorDropdownMenu } from "@/src/registry/default/plate-ui/color-dropdown-menu";
import { CommentToolbarButton } from "@/src/registry/default/plate-ui/comment-toolbar-button";
import { EmojiDropdownMenu } from "@/src/registry/default/plate-ui/emoji-dropdown-menu";
import { IndentListToolbarButton } from "@/src/registry/default/plate-ui/indent-list-toolbar-button";
import { IndentTodoToolbarButton } from "@/src/registry/default/plate-ui/indent-todo-toolbar-button";
import { IndentToolbarButton } from "@/src/registry/default/plate-ui/indent-toolbar-button";
import { LineHeightDropdownMenu } from "@/src/registry/default/plate-ui/line-height-dropdown-menu";
import { LinkToolbarButton } from "@/src/registry/default/plate-ui/link-toolbar-button";
import { ListToolbarButton } from "@/src/registry/default/plate-ui/list-toolbar-button";
import { MarkToolbarButton } from "@/src/registry/default/plate-ui/mark-toolbar-button";
import { MediaToolbarButton } from "@/src/registry/default/plate-ui/media-toolbar-button";
import { OutdentToolbarButton } from "@/src/registry/default/plate-ui/outdent-toolbar-button";
import { TableDropdownMenu } from "@/src/registry/default/plate-ui/table-dropdown-menu";
import { ToggleToolbarButton } from "@/src/registry/default/plate-ui/toggle-toolbar-button";
import { ToolbarGroup } from "@/src/registry/default/plate-ui/toolbar";
